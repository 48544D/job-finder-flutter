...
import 'package:job_finder/controllers/user/job_list_controller.dart';
...
class JobListState extends State<JobList> {
  ...
  get appliantsController => AppliantsController();
          ...
          actions: [
            Padding(
              ...
              child: IconButton(
                ...
                color: Colors.white,
                onPressed: () {
                  Get.toNamed('/user/edit-job', arguments: jobId);
                },
              ),
            )
          ],
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: FutureBuilder(
                          future: jobListController.fetchAppliedJobs(),
                ...
                Column(
                  ...
                  children: [
                    ...
                    //   child: FutureBuilder(
                    //       future: jobListController.getAppliants(jobId),
                    //       builder: (context, snapshot) {
                    //         if (snapshot.connectionState ==
                    //             ConnectionState.waiting) {
                    //           return const Center(
